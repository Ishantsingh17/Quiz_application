...
<html lang="en">
  ...
  <body>
    ...
    <nav>
        ...
        <a href="/register.php" class="food">Register</a>
    ...
    <div class="container">
        <form action="" method="post">
            <h1 class="main_heading">PLEASE LOGIN HERE</h1>
            <h2>Contact Information</h2>
           
            <p>Name: <input type="text" name="username" placeholder="Enter your name" required></p>
