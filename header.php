...
<body>
 ...
 while($row=mysqli_fetch_array($res))
 {
     ...
     ?>
     <input type="button" class="create" value="<?php echo $row["category"]; ?>" style="margin-top:10px; background-color: blue; color:white" onclick="set_exam_type_session(this.value);" > 
